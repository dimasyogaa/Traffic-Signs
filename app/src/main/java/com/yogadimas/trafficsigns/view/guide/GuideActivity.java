package com.yogadimas.trafficsigns.view.guide;
...
public class GuideActivity extends AppCompatActivity {
    ...
    public ArrayList<Signs> getListSigns() {
        String[] dataDescription = getResources().getStringArray(R.array.data_guide_description);
        @SuppressLint("Recycle")
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_guide_photo);

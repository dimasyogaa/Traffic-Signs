package com.yogadimas.trafficsigns.view.prohibition;
...
public class ProhibitionActivity extends AppCompatActivity {
    ...
    public ArrayList<Signs> getListSigns() {
        String[] dataDescription = getResources().getStringArray(R.array.data_prohibition_description);
        @SuppressLint("Recycle")
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_prohibition_photo);

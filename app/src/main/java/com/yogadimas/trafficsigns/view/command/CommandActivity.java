package com.yogadimas.trafficsigns.view.command;
...
public class CommandActivity extends AppCompatActivity {
    ...
    public ArrayList<Signs> getListSigns() {
        String[] dataDescription = getResources().getStringArray(R.array.data_command_description);
        @SuppressLint("Recycle")
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_command_photo);
